...
const ChatList = () => {
    ...
    const {page,size,category,searchTerm, searchType, orderBy, refresh} = useChatMove();

    useEffect(() => {
        getRoomList({page:page, size:size, category:category, searchTerm:searchTerm, searchType:searchType, orderBy:orderBy}).then(result=>{
