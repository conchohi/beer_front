...
{ icon: "운동.jpg",  id:"피트니스", name:"운동"},
{ icon: "게임.jpg",  id:"게임", name:"게임"},
{ icon: "고민상담.jpg",  id:"고민상담", name:"상담"},
{ icon: "대학생.jpg", id:"대학생", name:"대학"},
{ icon: "여행.jpg", id:"여행", name:"여행"},
{ icon: "친목.jpg", id:"친목", name:"친목"},
{ icon: "회사.jpg", id:"회사생활", name:"회사"}]

const CategorySelector = ({handleCategory}) => {

  return (
    <div className="lg:w-3/4 mx-auto relative flex flex-row">
