            ...
            <div className="w-1/2 rounded-2xl text-left">
              ...
              <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md shadow-md rounded px-8 pt-6 pb-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <div className="flex items-center justify-between">
                      <label
                        htmlFor="id"
                        className="text-pink-500 block text-sm font-medium leading-6"
                      >
                        아이디
                      </label>
                ...
                <p className="mt-4 text-center text-sm text-gray-500">
                  <a
                    href="/signup"
                    className="font-semibold leading-6 text-pink-500 hover:text-orange-600"
                  >
                    회원가입하러 가기
                  </a>
                </p>
                ...
                <div className="flex flex-col justify-center items-center mt-3 space-y-4">
                  <a
                    href="http://localhost:4040/oauth2/authorization/kakao"
                    className="w-full"
                  >
                  ...
                  <a
                    href="http://localhost:4040/oauth2/authorization/naver"
                    className="w-full"
                  >
