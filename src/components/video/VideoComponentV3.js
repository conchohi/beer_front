    ...
    <>
                    ...
                    <div className="relative">
                      <div className="pb-[56.25%] h-0 relative">
                        <video
                          ...
                          className="w-full h-full box-border p-3 absolute object-cover hidden"
                          autoPlay
                          playsInline
                        />
                        <img
                          ...
                          src={
                            participant.profileImage
                              ? `${API_SERVER_HOST}/api/user/${participant.profileImage}`
                              : "/logo/basic.png"
                          }
                        />
                      </div>
                      <span
                        ...
                        onClick={() => {
                          setClickUserNick(participant.nickname);
                        }}
                      >
                        <FaUserLarge size="40" />
                      </span>
      ...
      <div className="flex flex-row px-10">
        ...
        <div className="w-1/2 flex items-center justify-end gap-5 text-lg font-bold">
          <button
            className="py-3 w-1/4 bg-gray-600 text-white"
            onClick={clickGame}
          >
            게임 선택
          </button>
          <button className="py-3 w-1/4 bg-white" onClick={clickDestoryRoom}>
            방 폭파
          </button>
          <button
            className="py-3 w-1/4 bg-[#BE2222] text-white"
