...
//                       console.log(
//                         "Screen sharing session created: " + result["room"]
//                       );
...
//             return (
//               <div
//                 ref={(el) => (remoteFeedRef.current[feed.rfindex] = el)}
//                 className={
...
//                   <div className="relative">
//                     <video
//                       ref={(el) => (remoteVideoRef.current[feed.rfindex] = el)}
//                       className="w-full h-full box-border p-3"
//                       autoPlay
//                       playsInline
//                     />
