...
const DestoryCheckModal = ({ setCheckDestroy, destroy }) => {
    ...
    return (
        <div className="w-lvw h-lvh z-10 fixed top-0 left-0 bg-black/40">
            <div className="absolute bg-gray-800 top-1/2 left-1/2 w-[360px] h-[200px] z-50 -translate-x-1/2 -translate-y-1/2 rounded-3xl shadow border-2 border-pink-500">
                <div className="flex flex-col justify-center text-center h-full p-5">
                    <div className="h-2/3 px-6 flex justify-center items-center rounded-xl">
                        <span className=" text-2xl font-bold text-white tracking-wider">현재 채팅방을 <br /> 종료 하시겠습니까?</span>
                    </div>
