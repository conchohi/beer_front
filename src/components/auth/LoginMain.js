            ...
            <div className="bg-white w-full max-w-md rounded-2xl shadow-md p-6 md:p-8">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <button
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-pink-500 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-pink-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-500"
                  >
                    로그인
                  </button>
                </div>
              ...
              <div className="flex flex-col justify-center items-center mt-3 space-y-2">
                <button
                  className="w-full flex items-center bg-yellow-300 px-3 py-2 rounded-md text-sm font-semibold leading-6 text-black shadow-sm hover:bg-yellow-400"
                ...
                <button
                  className="w-full flex items-center bg-green-500 px-3 py-2 rounded-md text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-600"
