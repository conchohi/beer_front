    ...
    <>
      ...
      <BasicLayout>
        <div className="w-full h-auto font-bold text-2xl md:text-4xl text-black font-sans p-6 md:px-60 md:py-30 flex flex-col ">
          <div className="bg-white w-full h-auto rounded-2xl flex p-6 md:p-12 ">
            <div className="w-1/2 flex justify-center items-center bg-slate-200 rounded-2xl">
              <MovingCat />
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <div className="flex items-center justify-between">
                      <label
                        htmlFor="id"
                        className="text-pink-500 block text-sm font-bold leading-6"
                      >
                        아이디
                      </label>
