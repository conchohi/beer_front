...
const CommentListComponent = ({ comments, editingCommentId, editingCommentContent, handleEditCommentChange, handleDeleteComment, setEditingCommentId, setEditingCommentContent }) => {
